import { Component, ChangeDetectionStrategy, Input, HostBinding, Output, EventEmitter, ViewChild, ChangeDetectorRef, OnInit, OnDestroy } from '@angular/core';
...
export class QuickChatComponent implements OnInit, OnDestroy {
  ...
  messages: any[] = [
    ...
    { type: 'text', dir: 'left', mp: './assets/logo-color.svg', msg: '请<span class="text-success">一句话</span>描述您的问题，我们来帮您解决并转到合适的人工服务。😎' },
  ];
  text = '';
  inited: boolean;
  hasMessage = false;

  @ViewChild('messageScrollbar') messageScrollbar?: ScrollbarDirective;
